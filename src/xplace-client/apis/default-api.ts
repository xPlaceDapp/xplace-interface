...
import { PixelConfigBo } from '../models';
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        pixelsControllerGetConfig: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/pixels/config`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async pixelsControllerGetConfig(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PixelConfigBo>>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).pixelsControllerGetConfig(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async pixelsControllerGetConfig(options?: AxiosRequestConfig): Promise<AxiosResponse<PixelConfigBo>> {
            return DefaultApiFp(configuration).pixelsControllerGetConfig(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} x 
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public async pixelsControllerGetConfig(options?: AxiosRequestConfig) : Promise<AxiosResponse<PixelConfigBo>> {
        return DefaultApiFp(this.configuration).pixelsControllerGetConfig(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {number} x 
